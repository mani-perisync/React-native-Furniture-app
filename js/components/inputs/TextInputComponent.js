...
export const TextInputCompnent = ({ size,onPress,placeholder,placeholderTextColor, value, onChangeText, editable, onKeyPress, maxLength, keyboardType, enableClear, clearPressed, style }) => {
        ...
        <View style={[styles.row, padding(10), styles.centerHorizontal, borderWidth(0.5), radius(6), borderColor(Colors.blue),style]}>
            <View style={[styles.row, flex(1.5), value == "" && opacity(0.7), styles.centerHorizontal ]}>
                <TextInput
                    ...
                    style={[ textColor(darkMode), fontSize(size? size: 18), flex(1), padding(0, 6, 12)]}
                />
